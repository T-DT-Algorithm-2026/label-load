/// Custom key binding integration test.
library;
...
void main() {
  ...
  testWidgets('customize next-image binding via key press', (tester) async {
    ...
    await tester.tap(find.text(l10n.actionNextImage));
    await tester.pump();

    await tester.sendKeyEvent(LogicalKeyboardKey.keyJ);
    await tester.pumpAndSettle();

    final binding = keyBindingsProvider.getBinding(BindableAction.nextImage);
    expect(binding.key, equals(LogicalKeyboardKey.keyJ));
